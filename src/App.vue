<template>
  <div class="container">
    <GanttComponent class="left-container" style='width:700px; height:600px;' :tasks="tasks"></GanttComponent>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      tasks: {
        data: [
          {id: 11, text: "Project #1sdfaddddddd", start_date: "", duration: 0, progress: 0.6, open: true},
